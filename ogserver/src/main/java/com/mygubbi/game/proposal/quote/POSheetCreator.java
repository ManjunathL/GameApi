 ...
 */
public class POSheetCreator
{
    private final static Logger LOG = LogManager.getLogger(POSheetCreator.class);

    private QuoteData quoteData;
    private Sheet poSheet;
    private CellStyle boldStyle;

    public POSheetCreator(Sheet poSheet, QuoteData quoteData, CellStyle boldStyle)
    {
        this.poSheet = poSheet;
    ...
    {
        Row dataRow = this.poSheet.createRow(rowNum);
