...
{
    public static final String XL_FILE = "C:\\Users\\user\\Downloads\\MG-MASTER SHEET_STORAGE MODULES - GAME.xlsx";
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        //      dataPreparer.processSheet(92, 0, new ModuleComponentHandler());
