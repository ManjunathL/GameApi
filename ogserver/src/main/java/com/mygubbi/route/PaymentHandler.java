...
//            System.out.println("decodedBytes " + new String(decodedBytes));
            if(Objects.equals(status, "failure")){
                ...
                RouteUtil.getInstance().redirect(routingContext, "https://mydev1.mygubbi.com/payfailure-" + encryptTxn, "Redirecting to new Success Page");
                ...
                RouteUtil.getInstance().redirect(routingContext, "https://mydev1.mygubbi.com/paysuccess-" + encryptTxn, "Redirecting to new Success Page");
            }
        }
