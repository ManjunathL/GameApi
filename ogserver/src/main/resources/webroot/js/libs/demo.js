...
var shownnnone = "yes";
var dropdone = document.getElementById("image-dropdown-one");

function showww() {
  dropdone.style.height = "auto";
  dropdone.style.overflow = "y-scroll";
}

function hideee() {
    dropdone.style.height = "30px";
    dropdone.style.overflow = "hidden";
  }
  //dropd.addEventListener('mouseover', showOrHide, false);
  //dropd.addEventListener('click',showOrHide , false);


function myfuuncone(imgParent) {
  hideee();
  var mainDIVV = document.getElementById("image-dropdown-one");
  imgParent.parentNode.removeChild(imgParent);
  mainDIVV.insertBefore(imgParent, mainDIVV.childNodes[0]);
}

var shownnn = "yes";
var dropd = document.getElementById("image-dropdown-two");
...
function myfuunc(imgParent) {
  hideee();
  var mainDIVV = document.getElementById("image-dropdown-two");
  imgParent.parentNode.removeChild(imgParent);
  mainDIVV.insertBefore(imgParent, mainDIVV.childNodes[0]);
}