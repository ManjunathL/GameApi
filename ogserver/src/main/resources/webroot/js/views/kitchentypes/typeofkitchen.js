...
define([
    ...
    'underscore',
    'backbone',
    'text!templates/kitchentypes/typeofkitchen.html',
    'cloudinary_jquery',
    'slyutil',
    'mgfirebase',
    'consultutil',
    'analytics'
], function($, _, Backbone, kitchenTypePageTemplate, CloudinaryJquery, SlyUtil, MGF, ConsultUtil, Analytics) {
    var kitchenTypePageVIew = Backbone.View.extend({
            el: '.page',
            ref: null,
            renderWithUserProfCallback: function(userProfData){
                $(this.el).html(_.template(kitchenTypePageTemplate)({
